...
type GetUsersOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.AllUsersResponse `json:"body,omitempty"`
}
...
func (o *GetUsersOK) WithPayload(payload *models.AllUsersResponse) *GetUsersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users o k response
func (o *GetUsersOK) SetPayload(payload *models.AllUsersResponse) {
	o.Payload = payload
}
...
func (o *GetUsersBadRequest) WithPayload(payload *models.GeneralResponse) *GetUsersBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users bad request response
func (o *GetUsersBadRequest) SetPayload(payload *models.GeneralResponse) {
	o.Payload = payload
}
...
func (o *GetUsersUnauthorized) WithPayload(payload *models.GeneralResponse) *GetUsersUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users unauthorized response
func (o *GetUsersUnauthorized) SetPayload(payload *models.GeneralResponse) {
	o.Payload = payload
}
...
func (o *GetUsersForbidden) WithPayload(payload *models.GeneralResponse) *GetUsersForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users forbidden response
func (o *GetUsersForbidden) SetPayload(payload *models.GeneralResponse) {
	o.Payload = payload
}
...
func (o *GetUsersNotFound) WithPayload(payload *models.GeneralResponse) *GetUsersNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users not found response
func (o *GetUsersNotFound) SetPayload(payload *models.GeneralResponse) {
	o.Payload = payload
}
...
func (o *GetUsersInternalServerError) WithPayload(payload *models.GeneralResponse) *GetUsersInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users internal server error response
func (o *GetUsersInternalServerError) SetPayload(payload *models.GeneralResponse) {
	o.Payload = payload
}
